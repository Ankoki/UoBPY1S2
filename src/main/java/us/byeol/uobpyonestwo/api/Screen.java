package us.byeol.uobpyonestwo.api;
...
public abstract class Screen extends ArrayList<JComponent> {
    ...
    /**
     * Gets a screen that's been created already [would have been initialized at {@link us.byeol.uobpyonestwo.gui.MainFrame#init()}
     * @param clazz
     * @return
     */
